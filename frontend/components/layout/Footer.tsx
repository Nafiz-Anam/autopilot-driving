          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                  ...
                  <div className="col-span-1">
                      <AutopilotLogo className="mb-4" size="default" />
                      <p className="text-[#9A9A9A] text-sm leading-relaxed mb-4">
                          UK&apos;s premier driving school. Expert DVSA-approved
                          instructors covering East London, Tower Hamlets,
                          Newham, Barking &amp; Dagenham and surrounding areas.
                      </p>
                      <div className="flex items-center gap-3 mt-4">
                          <a
                              href="https://www.instagram.com/autopilotdrivingschool"
                              target="_blank"
                          ...
                          <a
                              href="https://www.facebook.com/people/Autopilot-DrivingSchool/100091995016715/"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 text-[#6B6B6B] hover:text-[#FF5500] transition-colors"
                          >
                          ...
                          <a
                              href="https://www.tiktok.com/@autopilotdrivingschool"
                              target="_blank"
                              rel="noopener noreferrer"
                              className="p-2 text-[#6B6B6B] hover:text-[#FF5500] transition-colors"
                          >
                      ...
                      <ul className="space-y-2.5">
                          {[
                              ...
                              <li key={item.href}>
                                  <Link
                                      href={item.href}
                                      className="text-[#6B6B6B] hover:text-[#FF5500] text-sm transition-colors"
                                  >
                                      {item.label}
                                  </Link>
                              </li>
                      ...
                      <ul className="space-y-3">
                          <li>
                              <a
                                  ...
                                  className="flex items-start gap-2.5 text-[#9A9A9A] hover:text-[#FF5500] transition-colors text-sm"
                              >
                                  <Phone
                                      size={16}
          ...
          <div className="border-t border-[#1A1A1A]">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
                  <p className="text-[#6B6B6B] text-xs">
                      © {currentYear} Autopilot Driving School. All rights
                      reserved. Developed by{" "}
                      <a
                          href="https://signaturesolution.co.uk/"
                          target="_blank"
                          rel="noopener noreferrer"
