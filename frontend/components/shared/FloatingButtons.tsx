    ...
    <div className="fixed bottom-6 right-4 z-50 flex flex-col items-end gap-3">
      ...
      <div className="relative flex items-center">
        <motion.div
          ...
          className="absolute right-full mr-3 whitespace-nowrap rounded-full px-4 py-2 text-sm font-semibold text-white shadow-lg"
          style={{ background: "#25D366" }}
        >
          AI chat 24/7
          <span
            className="absolute top-1/2 -right-1 -translate-y-1/2 w-2.5 h-2.5 rotate-45"
            style={{ background: "#25D366" }}
          />
        </motion.div>
